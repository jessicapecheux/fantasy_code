...
<?php include("_header.php"); ?>
  <section>
    <div class="ourteam">
      ...
      <h3>Front End Dev</h3>
      <div class="hulk">
        <img src="/assets/images/hulk.png" alt="Hulk" class="hulkPic" />
        <p class="hulkQuote">
          <i>
      ...
      <h3>Data Analyst</h3>
      <div class="homer">
        <img src="/assets/images/homer.png" alt="Homer" class="homerPic" />
        <p class="homerQuote">
          <i>
      ...
      <h3>Back End Dev</h3>
      <div class="batman">
        <img src="/assets/images/batman.png" alt="Batman" class=" batmanPic" />
        <p class="batmanQuote">
          <i>
      ...
      <h3>Web Designer</h3>
      <div class="yoda">
        <img src="/assets/images/yoda.png" alt="Yoda" class="yodaPic" />
        <p class="yodaQuote">
          <i>
