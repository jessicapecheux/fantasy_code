...
<section class="welcomeBox">
    ...
    <p class="welcomeMsg">
        Our innovative philosophy is based on the latest web technologies, constantly evolving our fun and flexible learning method is very popular with recruiters!
    </p>
